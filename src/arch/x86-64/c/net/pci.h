...
#define PCI_VENDOR_ID_FIELD_OFFSET      0x00
#define PCI_DEVICE_ID_FIELD_OFFSET      0x02

#define PCI_COMMAND_FIELD_OFFSET        0x04
#define PCI_CLASS          0X0B
#define PCI_SUBCLASS       0X0A
#define PCI_BASE_ADDR_0    0x10
#define PCI_BASE_ADDR_0_FIELD_OFFSET    0x10
